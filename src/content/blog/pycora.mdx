...
excerpt: 'A PyTorch implementation of ragged tensors that reduces memory and bandwidth usage for variable-length data, avoiding the waste of traditional padding approaches.'
...
_[Code is available on GitHub](https://github.com/devksingh4/pycora)_
...
_This work was completed as part of coursework for CS 521 ML Compilers at the University of Illinois Urbana-Champaign._
