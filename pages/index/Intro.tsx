...
export const IntroComponent = () => {
  return (
    <>
      <p className="text-slate-200 mb-6 text-left text-lg">{portfolio.blurb}</p>

      <p className="text-slate-100 mb-6 text-left text-lg">
      ...
      <p className="text-gray-100 mb-6 text-left text-lg">
